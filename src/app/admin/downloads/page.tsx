...
import { ECOMMERCE_PRICING, PLAN_CATALOG, formatTwd, getPaymentGatewaySetupFee } from "@/lib/plans";
    ...
    <main className="min-h-screen bg-slate-950 p-5 text-white md:p-8">
      <div className="mx-auto max-w-6xl space-y-7">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
          ...
          <p className="mt-4 rounded-xl border border-amber-400/20 bg-amber-400/5 p-3 text-xs leading-5 text-amber-100">所有方案：月租串接金流另加 {formatTwd(getPaymentGatewaySetupFee("MONTHLY"))}；年租與一次買斷不收串接費。</p>
