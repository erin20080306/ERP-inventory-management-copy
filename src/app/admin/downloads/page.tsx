      ...
      <div className="mx-auto max-w-6xl space-y-7">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
          ...
          <div className="mt-6 rounded-xl border border-rose-400/20 bg-rose-400/5 p-4">
            ...
            <p className="mt-3 text-xs leading-5 text-slate-400">買斷包含官網修改設計與串接金流；月租如需此服務另付 {formatTwd(ECOMMERCE_PRICING.websiteDesignFee.MONTHLY)}，年租另付 {formatTwd(ECOMMERCE_PRICING.websiteDesignFee.ANNUAL)}。其他權益與一般企業 ERP、一般 POS、餐飲 POS 相同。</p>
          </div>
