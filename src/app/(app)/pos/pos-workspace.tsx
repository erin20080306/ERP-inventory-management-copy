      ...
      {lastReceipt && (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-900 p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => window.open(`/print/pos/${lastReceipt.id}?print=1`, "_blank", "noopener,noreferrer")} className="h-9 px-3 rounded-lg border border-emerald-300 bg-white/80 hover:bg-white text-sm font-semibold inline-flex items-center gap-2"><Printer className="h-4 w-4" />列印收據</button>
