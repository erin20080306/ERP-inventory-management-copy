...
// 值是 fields 命名空間的鍵；資料庫存的仍是 QUEUED／ISSUED 等代碼。
const STATUS_LABEL_KEYS: Record<string, string> = { QUEUED: "einvoiceQueued", ISSUED: "einvoiceIssued", FAILED: "failed", VOIDED: "voided" };
