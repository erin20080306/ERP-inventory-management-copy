...
export default function RegisterClient({ medicalEnabled = true }: { medicalEnabled?: boolean }) {
  ...
  useEffect(() => {
    ...
    if (medicalEnabled && (mode === "POS_MEDICAL" || mode === "MEDICAL")) setBusinessMode("POS_MEDICAL");
  }, [medicalEnabled]);
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur-2xl sm:p-7 lg:p-8">
          ...
          <form onSubmit={onSubmit} className="min-w-0 space-y-4">
            <fieldset className="min-w-0 space-y-2">
              ...
              <div className={`grid max-w-full snap-x snap-mandatory grid-flow-col auto-cols-[minmax(168px,1fr)] gap-2 overflow-x-auto pb-2 [scrollbar-width:thin] lg:grid-flow-row lg:auto-cols-auto lg:overflow-visible ${medicalEnabled ? "lg:grid-cols-5" : "lg:grid-cols-4"}`}>
